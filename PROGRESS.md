...
**当前阶段**：Phase 2（上下文压缩）实现+评测进行中；Phase 1 baseline 已捕获
...
- 2026-06-18 Phase 0 vLLM 跑通（5f09b4e）
- 2026-06-18 Phase 1 baseline 捕获 + Phase 2 压缩核心（c62471a）
- 2026-06-18 Phase 2 评测运行中（b8994kkqy）
